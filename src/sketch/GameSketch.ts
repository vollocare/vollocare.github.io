...
export class GameSketch {
  ...
  public currentControl: ControlMode = ControlMode.PLAYER;
  public isPVP: boolean = false;
  ...
  public draw(): void {
    if (!this.isInitialized) {
      ...
      this.p.fill(255);
      this.p.textAlign(this.p.CENTER as any, this.p.CENTER as any);
  ...
  public keyPressed(): void {
    ...
    try {
      ...
      if (key === 73) this.toggleStats(); // I - 統計資訊
      if (key === 79) this.toggleDebug(); // O - 除錯資訊
  ...
  public switchControl(mode: ControlMode): void {
  ...
  public getWorldMousePosition(): IVector {
    return {
